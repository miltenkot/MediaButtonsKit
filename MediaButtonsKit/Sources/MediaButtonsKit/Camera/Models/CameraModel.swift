...
final class CameraModel: Camera {
    ...
    private var useUserPreferredCamera: Bool
    ...
    init(useUserPreferredCamera: Bool = false,
         showImageSnapshotSheet: Bool,
         saveInLibrary: Bool) {
        ...
        self.captureService = CaptureService(useUserPreferredCamera: useUserPreferredCamera)
    }
    ...
    func capturePhoto() async {
        do {
            ...
            logger.info("photo capture \(photo.data.debugDescription)")
            if showImageSnapshotSheet {
                snapshot = photo
                isCameraPreviewPresented = false
            } else {
                if saveInLibrary {
