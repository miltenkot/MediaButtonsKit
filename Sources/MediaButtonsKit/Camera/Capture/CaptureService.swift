...
actor CaptureService {
    ...
    init(useUserPreferredCamera: Bool) {
    ...
    func start() async throws {
        logger.info("AVCaptureSession start running.")
    ...
    private func updateCaptureRotation(_ angle: CGFloat) {
        ...
        outputServices.forEach { $0.setVideoRotationAngle(angle, currentDevice: currentDevice) }
        logger.info("\(self.currentDevice)")
    }
