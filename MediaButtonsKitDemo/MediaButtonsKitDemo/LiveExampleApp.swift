...
struct LiveExampleApp: View {
    ...
    @State private var mainSheetPresented = false
    @State private var nestleIsPresented = false
    ...
    var body: some View {
        NavigationStack {
            Button {
                mainSheetPresented = true
            } label: {
                Text("Main Sheet Presented")
            }.sheet(isPresented: $mainSheetPresented) {
                Form {
                    Button {
                        nestleIsPresented = true
                    } label: {
                    ...
                    .sheet(isPresented: $nestleIsPresented) {
